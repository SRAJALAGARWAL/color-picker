...
export class Container extends Component{
    ...
    render(){
        return(
            <div className='container-lg justify-content-center mt-1 px-5' style={{height:"700px", backgroundColor:"#bfa3cc"}}>
                <h2 className='pt-5 d-flex justify-content-center fw-bolder'>
                      <span class="rainbow-text">C</span>
                      <span class="rainbow-text">o</span>
                      <span class="rainbow-text">l</span>
                      <span class="rainbow-text">o</span>
                      <span class="rainbow-text">r</span>
                      <span class="rainbow-text">-</span>
                      <span class="rainbow-text">P</span>
                      <span class="rainbow-text">i</span>
                      <span class="rainbow-text">c</span>
                      <span class="rainbow-text">k</span>
                      <span class="rainbow-text">e</span>
                      <span class="rainbow-text">r</span>
                      <span class="rainbow-text">🌈</span>
                </h2>
